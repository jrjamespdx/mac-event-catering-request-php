        ...
        <form action="" class="form-horizontal" id="form1">
            ...
            <div class="row">
                <div class="well span7" id="food">
                    ...
                    <input type="checkbox" name="food[2]" value="Lemonade" /> Lemonade <input name="ct[2]" class="input-mini"/> Per Gallon<br/>
                    ...
                    <input type="checkbox" name="food[8]" value="Individual Bags of Chips, Pretzels, and Tortilla Chips" /> Individual Bags of Chips, Pretzels, and Tortilla Chips <input name="ct[8]" class="input-mini"/> Per Person <br/>
